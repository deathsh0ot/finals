         ...
         with font-awesome or any other icon font library */}
                ...
                <i className="right fas fa-angle-left" />
                    ...
                    <ul className="nav nav-treeview">
                      ...
                      <li className="nav-item">
                        <NavLink to={`${match.url}/Form`} activeStyle={{ color: 'blue' }} className="nav-link">Curriculum Models</NavLink>
                      </li>
                      <li className="nav-item">
                        <NavLink to={`${match.url}/Users`} exact activeStyle={{ color: 'blue' }} className="nav-link">Users</NavLink>
                      </li>
                    </ul>
                  </li>
                </ul>
